...
void TRWorldGenerationAttachWall::GenerateWorld(TRTileMap* tile_map, int width, int height, int seed)
{
    ...
    TRTile* tile_dirt = TRTileManager::GetInst()->GetTileByKey(L"dirt");
    TRTile* tile_stone = TRTileManager::GetInst()->GetTileByKey(L"cobblestone");

    TRTileWall* tile_wall_dirt = TRTileManager::GetInst()->GetTileWallByKey(L"dirt");
    TRTileWall* tile_wall_stone = TRTileManager::GetInst()->GetTileWallByKey(L"cobblestone");
