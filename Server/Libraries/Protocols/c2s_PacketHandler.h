...
namespace ServerCore
{
	...
	public:
		static void Init() noexcept
		{
			...
			g_fpPacketHandler[net_etoi(PKT_ID::c2s_TRY_NEW_ROOM)] = [](const S_ptr<PacketSession>& pSession_, BYTE* const pBuff_, c_int32 len_)->const bool { return HandlePacket<Protocol::c2s_TRY_NEW_ROOM>(Handle_c2s_TRY_NEW_ROOM, pSession_, pBuff_, len_); };
			g_fpPacketHandler[net_etoi(PKT_ID::c2s_ARRIVE_NEW_ROOM)] = [](const S_ptr<PacketSession>& pSession_, BYTE* const pBuff_, c_int32 len_)->const bool { return HandlePacket<Protocol::c2s_ARRIVE_NEW_ROOM>(Handle_c2s_ARRIVE_NEW_ROOM, pSession_, pBuff_, len_); };
			g_fpPacketHandler[net_etoi(PKT_ID::c2s_APPEAR_NEW_OBJECT)] = [](const S_ptr<PacketSession>& pSession_, BYTE* const pBuff_, c_int32 len_)->const bool { return HandlePacket<Protocol::c2s_APPEAR_NEW_OBJECT>(Handle_c2s_APPEAR_NEW_OBJECT, pSession_, pBuff_, len_); };
		...
		static S_ptr<SendBuffer> MakeSendBuffer(Protocol::s2c_TRY_NEW_ROOM& pkt)noexcept { return MakeSendBuffer(pkt, PKT_ID::s2c_TRY_NEW_ROOM); }
		static S_ptr<SendBuffer> MakeSendBuffer(Protocol::s2c_ARRIVE_NEW_ROOM& pkt)noexcept { return MakeSendBuffer(pkt, PKT_ID::s2c_ARRIVE_NEW_ROOM); }
		static S_ptr<SendBuffer> MakeSendBuffer(Protocol::s2c_APPEAR_NEW_OBJECT& pkt)noexcept { return MakeSendBuffer(pkt, PKT_ID::s2c_APPEAR_NEW_OBJECT); }
